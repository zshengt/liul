...
<section>
    <ul class="nav nav-tabs">
      ...
      <li role="presentation"><a href="<?php echo U('Category/add');?>">话题添加</a></li>
    </ul>
    <br/>
    <table class="table">
        <tbody>
            <tr><th>ID</th><th>name</th><th>amount</th><th>cid</th><th>operation</th></tr>
        </tbody>
        <?php if(is_array($categorys)): foreach($categorys as $key=>$category): ?><tr>
                <td><?php echo ($category["id"]); ?></td><td><?php echo ($category["name"]); ?></td><td><?php echo ($category["amount"]); ?></td><td><?php echo ($category["cid"]); ?></td><td><a href="<?php echo U('Category/edit', array('id'=>$category['id']));?>"><img style="width:20px;height:20px;margin-top:-5px;" src="/Public/img/edit.png"/></a>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="<?php echo U('category/delete', array('id'=>$category['id']));?>"><img style="width:18px;height:18px;margin-top:-5px;" src="/Public/img/del.png"/></a>
                </td>
