...
<head lang="zh-cmn-Hans">
    ...
    <script src="/Public/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="/Public/js/verlet-1.0.0.js"></script>
    <title>众生堂</title>
</head>
<body style="background:#EEE;overflow:hidden;" >
    <ul style="position:absolute;left:200px;text-align:center;margin:15px;" >
        <?php if(is_array($articles['list'])): $i = 0; $__LIST__ = $articles['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><li style="padding:7px;">
    ...
    <canvas id="scratch" style="width: 800px; height: 500px; z-index: 999;position: absolute;right:100px;">
    </canvas>
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            var spider = sim.spider(new Vec2(width / 4, -300));
