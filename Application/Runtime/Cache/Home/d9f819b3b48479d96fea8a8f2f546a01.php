...
<body style="background-color:#EEE;">
    <div class="catalog">
        ...
        <div class="area">
            <ul class="nav nav-pills" style="float:right;margin-right:125px;">
  ...
  <div class="article" class="panel-body">
    ...
    <nav>
      <ul class="pagination pagearea">
        ...
        <?php $__FOR_START_28570__=1;$__FOR_END_28570__=$totalpage+1;for($i=$__FOR_START_28570__;$i < $__FOR_END_28570__;$i+=1){ ?><li class='<?php if($page == $i): ?>active<?php else: endif; ?>' >
